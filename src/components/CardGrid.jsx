  ...
  return (
    <>
        <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 w-5/6 mt-20 py-12 gap-16'>
            ...
            <Card text='Hydraulická ruka' svg={tow}/>
            <Card text='Jeřábnické práce' svg={svg_truck}/>
            {/* bumper by Ibrahim Nuruz from Noun Project (CC BY 3.0) */}
            <Card text='Doprava stavebního materiálu' svg={bumper} svgSize={9}/>
            {/* Metal icon by Chintuza from Noun Project (CC BY 3.0) */}
            <Card text='Prodej materiálu pro Vaši stavbu' svg={metal} />
            <div className='col-span-1 sm:col-span-2 xl:col-span-1'>
              <Card text='Přeprava TINY HOUSŮ' svg={transport}/>
            </div>
        </div>
    </>
  )
